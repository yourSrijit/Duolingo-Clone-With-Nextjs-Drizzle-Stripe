    ...
    variants: {
      variant: {
        default:
          ...
          sidebar:"bg-trasparent text-slate-500 border-2 border-transparent hover:bg-slate-100 tansition-none",
          sidebarOutline:"bg-sky-500/15 text-sky-500 border-sky-300 border-2 hover:bg-sky-500/20 tansition-none",
      },
      size: {
