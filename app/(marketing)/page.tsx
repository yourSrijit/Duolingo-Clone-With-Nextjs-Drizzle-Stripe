  ...
  return (
    <div className="max-w-[988px] mx-auto flex-1 flex flex-col w-full lg:flex-row items-center justify-center p-4 gap-2">
      <div className="relative w-[240px] h-[240px] lg:w-[440px] lg:h-[440px] mb-8 lg:mb-0">
        <Image src="/home1.gif" fill alt="home image"/>
      </div>
      <div className="flex flex-col items-center gap-y-8">
        <h1 className="text-center text-xl lg:text-3xl font-bold text-neutral-600 max-w-[480px]">The free, fun, and effective way to learn a language!🐲</h1>
        <div>
          <ClerkLoading>
